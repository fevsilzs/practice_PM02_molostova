...
app = Flask(__name__)
app.secret_key = '6f5c9e60e8cf3b8553a8c8e785f6199d'  # В реальном проекте хранить в .env

# Настройки MySQL
app.config['MYSQL_HOST'] = 'localhost'
app.config['MYSQL_USER'] = 'root'
app.config['MYSQL_PASSWORD'] = '1234'  # Ваш пароль от MySQL
app.config['MYSQL_DB'] = 'pizzeria_db'  # Имя вашей БД
